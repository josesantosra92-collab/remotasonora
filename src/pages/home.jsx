    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main id="main" role="main">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-12 md:py-16 grid md:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <ul className="grid gap-5">
                  {t.hero.bullets.map((b, i) => {
                    const bulletIcons = [
                      ...
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path className="group-hover:animate-[lookAround_3s_ease-in-out_infinite]" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" style={{transformOrigin: '12px 12px'}} />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                        <style>
                          {`@keyframes lookAround { 0%, 100% { transform: translateX(0); } 33% { transform: translateX(2px); } 66% { transform: translateX(-2px); } }`}
                        </style>
                      </svg>
                    ];
                    const gradients = [
